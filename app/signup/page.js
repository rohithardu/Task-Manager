...
router.push("/dashboard")
  ...
  <div className='bg-gray-100 min-h-screen flex justify-center items-center'>
    <div className='bg-white h-[70vh] w-[50vw] shadow-lg flex flex-col justify-center items-center gap-5'>
        <input type="text" onChange={handleChange} value={form.name} name='name' id='name' className='bg-gray-100 px-4 py-1 rounded-lg w-1/2 h-10 outline' placeholder='Enter your name' />
        ...
        <button onClick={register} className="px-8 py-2 bg-green-400 rounded-full cursor-pointer font-semibold">Signup</button>
        <Link href={"/login"}>
